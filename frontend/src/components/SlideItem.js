          ...
          {shop &&
            <div className="flex justify-between">
              ...
              <div className="flex items-center justify-end">
                <button onClick={() => addItem(me, item, dispatch, setError)} className="right-0 bg-green-500 text-white px-3 py-2 hover:bg-green-800 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Buy</button>
              </div>
            </div>
          }
        </div>
